...
public class NuclearCoreLibraryModTabs {
	...
	public static final RegistryObject<CreativeModeTab> NUCLEAR_CORE = REGISTRY.register("nuclear_core",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.nuclear_core_library.nuclear_core")).icon(() -> new ItemStack(NuclearCoreLibraryModBlocks.RAW_URANIUM_BLOCK.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(NuclearCoreLibraryModBlocks.RAW_URANIUM_BLOCK.get().asItem());
			}).build());
